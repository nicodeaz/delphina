                ...
                <div class="rounded-[2rem] bg-white p-5 shadow-xl ring-1 ring-stone-100 md:p-8">
                    <div class="grid gap-3 border-b border-stone-100 pb-8 md:grid-cols-4">
                        @foreach([
                            ...
                            <button type="button" class="js-step-indicator flex items-center gap-3 rounded-2xl border border-stone-200 px-4 py-4 text-left transition" data-step="{{ $index }}">
                            ...
                            <section class="js-step-panel hidden" data-step-panel="4">
                                ...
                                <div class="mt-6 rounded-[2rem] border border-stone-200 bg-stone-50 p-6">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <label for="terms" class="text-sm text-gray-700">I agree to the <a href="{{ route('policies') }}" class="font-medium text-olive hover:underline">Terms & Conditions</a> and <a href="{{ route('policies') }}" class="font-medium text-olive hover:underline">Privacy Policy</a>. A €15 deposit is required to secure the appointment.</label>
                                    </div>
                                </div>
