                        ...
                        <div class="space-y-6">
                            ...
                            <div class="service-category border border-gray-200 rounded-xl overflow-hidden">
                                ...
                                <div class="hidden px-6 py-4 space-y-3 bg-white">
                                    @foreach($services->where('category', 'gel') as $service)
                                    <label class="flex items-start space-x-4 p-4 border border-gray-200 rounded-lg hover:border-olive-300 hover:bg-olive-50 transition-all cursor-pointer group">
                                        ...
                                        <div class="flex-1">
                                            <h3 class="text-lg font-medium text-gray-900 group-hover:text-olive-600 transition-colors">{{ $service->name }}</h3>
                                            ...
                                            <div class="flex justify-between items-center">
                                                ...
                                                <span class="text-xl font-bold text-olive-600">€{{ $service->price }}</span>
                                            </div>
                                        </div>
                                    </label>
                                    @endforeach
                            ...
                            <div class="service-category border border-gray-200 rounded-xl overflow-hidden">
                                ...
                                <div class="hidden px-6 py-4 space-y-3 bg-white">
                                    @foreach($services->where('category', 'biab') as $service)
                                    <label class="flex items-start space-x-4 p-4 border border-gray-200 rounded-lg hover:border-olive-300 hover:bg-olive-50 transition-all cursor-pointer group">
                                        <input type="checkbox" class="service-checkbox mt-1 w-4 h-4 text-olive-600 bg-gray-100 border-gray-300 rounded focus:ring-olive-500 focus:ring-2"
                                               data-service="{{ $service->name }}"
                                               data-price="{{ $service->price }}"
                            ...
                            <div class="service-category border border-gray-200 rounded-xl overflow-hidden">
                                ...
                                <div class="hidden px-6 py-4 space-y-3 bg-white">
                                    @foreach($services->where('category', 'soft_gel') as $service)
                                    <label class="flex items-start space-x-4 p-4 border border-gray-200 rounded-lg hover:border-olive-300 hover:bg-olive-50 transition-all cursor-pointer group">
                                        <input type="checkbox" class="service-checkbox mt-1 w-4 h-4 text-olive-600 bg-gray-100 border-gray-300 rounded focus:ring-olive-500 focus:ring-2"
                                               data-service="{{ $service->name }}"
                                               data-price="{{ $service->price }}"
                            ...
                            <div class="service-category border border-gray-200 rounded-xl overflow-hidden">
                                ...
                                <div class="hidden px-6 py-4 space-y-3 bg-white">
                                    @foreach($services->where('category', 'polish') as $service)
                                    <label class="flex items-start space-x-4 p-4 border border-gray-200 rounded-lg hover:border-olive-300 hover:bg-olive-50 transition-all cursor-pointer group">
                                        <input type="checkbox" class="service-checkbox mt-1 w-4 h-4 text-olive-600 bg-gray-100 border-gray-300 rounded focus:ring-olive-500 focus:ring-2"
                                               data-service="{{ $service->name }}"
                                               data-price="{{ $service->price }}"
                            ...
                            <div class="service-category border border-gray-200 rounded-xl overflow-hidden">
                                ...
                                <div class="hidden px-6 py-4 space-y-3 bg-white">
                                    @foreach($services->where('category', 'addon') as $service)
                                    <label class="flex items-start space-x-4 p-4 border border-gray-200 rounded-lg hover:border-olive-300 hover:bg-olive-50 transition-all cursor-pointer group">
                                        <input type="checkbox" class="service-checkbox mt-1 w-4 h-4 text-olive-600 bg-gray-100 border-gray-300 rounded focus:ring-olive-500 focus:ring-2"
                                               data-service="{{ $service->name }}"
                                               data-price="{{ $service->price }}"
                    ...
                    <div class="bg-gray-50 rounded-xl p-6">
                        <div class="flex items-start space-x-3 mb-4">
                            ...
                            <label for="terms" class="text-sm text-gray-700">
                                I agree to the <a href="{{ route('policies') }}" class="text-olive hover:underline">Terms & Conditions</a> and
                                <a href="{{ route('policies') }}" class="text-olive hover:underline">Privacy Policy</a> *
                            </label>
                        </div>
