...
<?php $__env->startSection('title', 'Admin Login - Nails by Delphina'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <!-- Back to Site -->
        <div class="text-center">
            <a href="<?php echo e(route('home')); ?>" class="text-sm text-gray-600 hover:text-olive transition-colors">
                ← Back to website
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\delphina\resources\views/admin/login.blade.php ENDPATH**/ ?>