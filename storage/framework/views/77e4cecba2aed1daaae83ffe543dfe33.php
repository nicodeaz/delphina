        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 md:h-20">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center group">
                    <img src="<?php echo e(asset('img/logo_green.png')); ?>" alt="Delfina logo" class="h-11 md:h-16 w-auto object-contain">
                </a>
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    <div class="flex items-center space-x-2 mb-4">
                        ...
                        <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Nail Art Logo" class="h-12 md:h-14 w-auto object-contain">
                    </div>
