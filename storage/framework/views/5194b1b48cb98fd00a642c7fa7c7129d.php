...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-brand-cream via-white to-brand-pink/10">
    ...
    <div class="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <a href="<?php echo e(route('booking.create')); ?>" class="px-8 py-4 bg-gradient-to-r from-instagram-pink to-instagram-purple text-white rounded-full font-bold hover:shadow-xl transition-all transform hover:scale-105 text-lg inline-flex items-center justify-center shadow-lg">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    bookNowBtn.addEventListener('click', function() {
        if (Object.keys(selectedServices).length > 0) {
            ...
            window.location.href = `<?php echo e(route('book')); ?>?services=${serviceNames}`;
        }
    });
});
</script>
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-4">
                        <div class="flex items-center space-x-4 text-white text-sm font-medium">
                            <span><i class="fas fa-heart mr-1"></i><?php echo e($post['likes']); ?></span>
                            <span><i class="fas fa-comment mr-1"></i><?php echo e($post['comments']); ?></span>
                        </div>
...
<section class="py-20 bg-gradient-to-r from-olive/95 to-green-700/95">
    <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('book')); ?>" class="px-12 py-4 bg-white text-olive rounded-lg font-bold text-lg hover:shadow-xl transition-all transform hover:scale-105">
