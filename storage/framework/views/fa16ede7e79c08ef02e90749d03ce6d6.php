                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-olive-100 rounded-full flex items-center justify-center">
                                        <span class="text-sm font-medium text-olive-700"><?php echo e(substr($appointment->user->name, 0, 1)); ?></span>
                                    </div>
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($appointment->user->name); ?></div>
                                        <div class="text-sm text-gray-500"><?php echo e($appointment->user->email); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($appointment->payment): ?>
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full
                                        <?php if($appointment->payment->status == 'completed'): ?> bg-green-100 text-green-800
                                        <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                        <?php echo e($appointment->payment->status == 'completed' ? 'Paid' : 'Pending'); ?>
