...
<?php $__env->startSection('title', 'Payment - Nail Art Studio'); ?>
    ...
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <div class="mb-6">
                ...
                <h3 class="text-xl font-bold text-gray-900"><?php echo e($appointment->service->name); ?></h3>
                <p class="text-gray-600"><?php echo e($appointment->service->description); ?></p>
            </div>
            ...
            <div class="space-y-4 py-6 border-y border-gray-200">
                <div class="flex justify-between">
                    ...
                    <span class="font-bold text-gray-900"><?php echo e($appointment->date->format('l, d F Y')); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Time</span>
                    <span class="font-bold text-gray-900"><?php echo e($appointment->time); ?></span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Duration</span>
                    <span class="font-bold text-gray-900"><?php echo e($appointment->service->duration); ?> minutes</span>
                </div>
            </div>
        ...
        <div>
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-6">
                ...
                <form action="<?php echo e(route('payments.process', $appointment)); ?>" method="POST" id="payment-form">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Back Link -->
            <a href="<?php echo e(route('home')); ?>" class="block text-center px-6 py-3 text-gray-700 hover:text-gray-900 transition-colors font-medium">
                ← Back to Home
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\delphina\resources\views/payments/show.blade.php ENDPATH**/ ?>